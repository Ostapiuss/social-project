  ...
  return (
    <section className="nav__bar">
      ...
      <ul className="nav__navigation navigation">
        ...
        <li className="navigation__item">
          <div className="navigation__contain">
            <object data={ email } alt="email" className="navigation__icon"></object>
            <Link
              to="emails"
              className="navigation__link"
            >
        ...
        <li className="navigation__item">
          <div className="navigation__contain">
            <object data={ calendar } alt="dashboard" className="navigation__icon"></object>
            <Link
              to="/calendar"
              className="navigation__link"
            >
        ...
        <li className="navigation__item">
          <div className="navigation__contain">
            <object data={ pages } alt="dashboard" className="navigation__icon"></object>
            <Link
              to="/pages"
              className="navigation__link"
            >
